...
#   --tag-prefix ""         default: "" (set to "v" if you want tags like v1.0.0)
...
MAVEN_LOCAL="false"
MAVEN_LOCAL_CMD="${MAVEN_LOCAL_CMD:-./gradlew :crashkit:publishToMavenLocal}"
